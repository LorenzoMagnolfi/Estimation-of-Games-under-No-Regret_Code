function [distY_time, distY_time_obs, final_regret, Pl1_EmpRegr, Pl2_EmpRegr] = learn_mod(N, M, M_obs, numdst_t, numdst_t_obs, Nobs_Pl1, Nobs_Pl2)
...
for t = 1:(N+M)
    ...
    mc_draw = marginal_cost_draws_v4_new(type_space, 1);
